...
sparse() { git -C "$HOME_DIR" sparse-checkout set --no-cone '/machine/'; }
...
[ -d "$HOME_DIR/machine" ] || die "no machine/ in $HOME_DIR — wrong branch?"

INSTALL="$HOME_DIR/machine/install.sh"
