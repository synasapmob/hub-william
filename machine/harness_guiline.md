...
Full tag rules live under `machine/catalog/harness/tags/`:
...
- `machine/catalog/harness/github/gh-cli.md` — GitHub operations through `gh`.
- `machine/catalog/harness/github/clickable-references.md` — clickable Linear,
  PR and commit labels with verified lifecycle markers.
- `machine/catalog/harness/github/report-summary.md` — Git/PR final summary.
- `machine/catalog/harness/linear/creation-policy.md` — default-deny issue
  creation budget and no automatic decomposition/blocking relationships.
- `machine/catalog/harness/linear/delivery-readiness.md` — fill missing
  assignee/estimate metadata for delivery from an existing issue.
- `machine/catalog/harness/linear/requirements-freshness.md` — pre-code and
  final traceability audit for verified existing-issue delivery.
- `machine/catalog/harness/linear/freshness-report-summary.md` — compact
  freshness verdict, sources, reconciliation, conflicts and artifact handoff.
- `machine/catalog/harness/linear/report-summary.md` — Linear final summary.
- `machine/catalog/harness/evidence/test-evidence.md` — backend/frontend test
  logs, history and the compact final handoff.
- `machine/catalog/harness/evidence/approach-history.md` — shared append-only
  per-task implementation approach and before/after flow.
- `machine/catalog/harness/evidence/report-summary.md` — evidence final summary.
- `machine/catalog/harness/playwright/report-summary.md` — browser flow,
  screenshots, observed/fixed bugs and scoped cleanup summary.
- `machine/catalog/harness/projects/routing.md` — Git-remote-first GitHub,
  Linear and delivery-base preflight.
- `machine/catalog/harness/projects/registry.yaml` — direct per-project GitHub
  URL and Linear workspace/team configuration.
- `machine/catalog/contrib/synasapmob/hooks/supabase-routing.md` — repository-to-MCP routing,
...
- Canonical harness: `~/.hub-william/machine/catalog/harness/AGENTS.md`
- PR template: `~/.hub-william/machine/catalog/templates/github-pull-request.md`
- Linear template: `~/.hub-william/machine/catalog/templates/linear-issue.md`
- Test evidence template: `~/.hub-william/machine/catalog/templates/test-evidence.md`
- Approach history template: `~/.hub-william/machine/catalog/templates/approach-history.md`
- Requirements freshness template: `~/.hub-william/machine/catalog/templates/requirements-freshness.md`
- Project registry: `~/.hub-william/machine/catalog/harness/projects/registry.yaml`
...
`machine/catalog/skills/frontend-convention/`; future backend rules belong in
`machine/catalog/skills/backend-convention/`, with the same separate-skill
...
```sh
~/.hub-william/machine/install.sh update --yes
```
