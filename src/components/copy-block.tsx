...
export default function CopyBlock({ source }: CopyBlockProps) {
  ...
  return (
    <div className="relative">
      <pre className="max-h-160 overflow-y-auto rounded-xl border border-zinc-800 bg-zinc-950 p-4 pt-12 font-mono text-[11px] leading-relaxed break-words whitespace-pre-wrap text-zinc-100">
        <code>{source}</code>
      </pre>
