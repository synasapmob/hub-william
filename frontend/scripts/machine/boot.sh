...
#     repos/Southern-Discoveries/hub-william/contents/frontend/scripts/machine/boot.sh | sh
#
...
[ -d "$HOME_DIR/frontend/scripts/machine" ] || die "no frontend/scripts/machine in $HOME_DIR — wrong branch?"

INSTALL="$HOME_DIR/frontend/scripts/machine/install.sh"
