...
```sh
~/.hub-william/frontend/scripts/machine/install.sh init       # browse the catalog and pick
~/.hub-william/frontend/scripts/machine/install.sh update     # pull, then sync
~/.hub-william/frontend/scripts/machine/install.sh mcp auth   # log in to the OAuth servers
~/.hub-william/frontend/scripts/machine/install.sh status     # catalog, CLIs, profile, pending
```
...
`frontend/public/install.py` clones into **`~/.hub-william`**, sparse and blobless, so
only `scripts/` and `contributors/` land in the working tree — the frontend is
not part of a machine install.
...
cp "$old"/frontend/scripts/machine/profiles/local.toml ~/.hub-william/frontend/scripts/machine/profiles/
cp "$old"/frontend/scripts/machine/state/applied.json  ~/.hub-william/frontend/scripts/machine/state/
~/.hub-william/frontend/scripts/machine/install.sh init
```
