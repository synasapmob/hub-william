...
`,O=`# Existing Linear delivery readiness
...
`,j=`# Existing Linear requirements freshness gate
...
-->
`,L=`# Linear delivery issue template
...
-->
`,_e=`description = "Chrome DevTools: console, network and performance traces."
command = "npx"
args = ["-y", "chrome-devtools-mcp"]
`,ve=`description = "Linear issues and projects. OAuth: run \`./install.sh mcp auth linear\`."
url = "https://mcp.linear.app/mcp"
`,ye=`description = "Notion pages and databases. OAuth: run \`./install.sh mcp auth notion\`."
url = "https://mcp.notion.com/mcp"
`,be=`description = "Drive a real browser to verify frontend changes."
command = "npx"
args = ["-y", "@playwright/mcp@latest"]
`,xe=`# hub-william's Postgres, and the only way in. There is no \`sb-*\` wrapper any
...
`,Se=`# sonix-study's Postgres. Same shape as supabase-hub-william.toml, which
...
`,Ce=new Set([`draft`,`merge`,`mergeable`,`rebase`]),we={documents:{label:`Documents`,summary:`Install the catalogue globally or add its managed rules to one project.`},evidences:{label:`Evidences`,summary:`Contracts for recording approaches, test runs and the evidence behind a handoff.`},github:{label:`GitHub`,summary:`Git, pull request and GitHub contracts, including merge, mergeability, draft and rebase workflows.`},gateway:{label:`Gateway`,summary:`Point Codex, Claude Code, Antigravity and Grok at Hub William with one installer, or paste the config yourself.`},mcp:{label:`MCP`,summary:`Register the supported MCP servers across the agents installed on this machine.`},skills:{label:`Skills`,summary:`Focused capabilities loaded when a task matches, with their supporting references kept together.`},tags:{label:`Tags`,summary:`Prompt tokens that select an execution mode or modify how a task is handled.`},templates:{label:`Templates`,summary:`Reusable shapes for issues, pull requests, evidence and implementation histories.`}},Te={library:[`evidences`,`github`,`tags`,`skills`,`templates`],tools:[`documents`,`gateway`,`mcp`]};function Ee(e){return(e.split(`/`).at(-1)??e).replace(/\.[^.]+$/,``)}function R(e){return e.section===`tools`?e.category===`installer`?`documents`:e.category:e.group===`evidence`?`evidences`:e.group===`github`||e.group===`tags`&&Ce.has(Ee(e.path))?`github`:e.group===`tags`?`tags`:e.category===`skills`?`skills`:e.category===`templates`?`templates`:e.group||e.category}function z(e){let t=e.replace(/^\/+/,``).split(`/`);if(t[0]!==`contributors`||t.length<4)return null;let n=t[2],r=n===`libraries`?`library`:n===`tools`?`tools`:null;if(!r)return null;let i=t[3]??``,a=t.slice(4);if(r===`library`&&i===`harness`&&a[0]===`AGENTS.md`)return`tags`;let o=i===`hooks`?`harness`:i,s=i;return o===`skills`||o===`templates`?s=o:a.length>1&&(s=a[0]??i),R({path:e,section:r,category:o,group:s})}function De(e){let t=we[e];if(t)return t;let n=e.replace(/[-_]/g,` `),r=n.charAt(0).toUpperCase()+n.slice(1);return{label:r,summary:`Documents collected around ${r.toLowerCase()}.`}}function Oe(e,t,n){let r=Te[e],i=r.indexOf(t),a=r.indexOf(n);return i!==-1||a!==-1?i===-1?1:a===-1?-1:i-a:t.localeCompare(n)}var ke=`contributors`,B=`default`,Ae=`https://github.com/synasapmob/hub-william`,je={hooks:`harness`},Me={github:`GitHub`,mcp:`MCP`,harness:`Harnesses`};function Ne(e){let t=Me[e];if(t)return t;let n=e.replace(/[-_]/g,` `);return n.charAt(0).toUpperCase()+n.slice(1)}var V=Object.fromEntries(Object.entries(Object.assign({"../../../../../contributors/default/libraries/harness/AGENTS.md":ee,"../../../../../contributors/default/libraries/harness/evidence/approach-history.md":te,"../../../../../contributors/default/libraries/harness/evidence/report-summary.md":ne,"../../../../../contributors/default/libraries/harness/evidence/test-evidence.md":re,"../../../../../contributors/default/libraries/harness/github/clickable-references.md":ie,"../../../../../contributors/default/libraries/harness/github/gh-cli.md":ae,"../../../../../contributors/default/libraries/harness/github/report-summary.md":oe,"../../../../../contributors/default/libraries/harness/tags/answer.md":se,"../../../../../contributors/default/libraries/harness/tags/delivery-verify.md":ce,"../../../../../contributors/default/libraries/harness/tags/delivery.md":le,"../../../../../contributors/default/libraries/harness/tags/draft.md":ue,"../../../../../contributors/default/libraries/harness/tags/guess.md":de,"../../../../../contributors/default/libraries/harness/tags/ignore.md":fe,"../../../../../contributors/default/libraries/harness/tags/linear.md":pe,"../../../../../contributors/default/libraries/harness/tags/merge.md":me,"../../../../../contributors/default/libraries/harness/tags/mergeable.md":he,"../../../../../contributors/default/libraries/harness/tags/plan.md":ge,"../../../../../contributors/default/libraries/harness/tags/playwright.md":d,"../../../../../contributors/default/libraries/harness/tags/rebase.md":f,"../../../../../contributors/default/libraries/harness/tags/report.md":p,"../../../../../contributors/default/libraries/harness/tags/worktree.md":m,"../../../../../contributors/default/libraries/skills/frontend-convention/SKILL.md":h,"../../../../../contributors/default/libraries/skills/frontend-convention/references/frontend-conventions.md":g,"../../../../../contributors/default/libraries/skills/frontend-verify/SKILL.md":_,"../../../../../contributors/default/libraries/skills/supabase-remote/SKILL.md":v,"../../../../../contributors/default/libraries/templates/approach-history.md":y,"../../../../../contributors/default/libraries/templates/requirements-freshness.md":b,"../../../../../contributors/default/libraries/templates/test-evidence.md":x,"../../../../../contributors/default/tools/gateway/gateway.md":S,"../../../../../contributors/default/tools/installer/download-and-inject.md":C,"../../../../../contributors/default/tools/installer/machine-installer.md":w,"../../../../../contributors/default/tools/mcp/mcp-servers.md":T,"../../../../../contributors/synasapmob/libraries/harness/dopa-tps.md":E,"../../../../../contributors/synasapmob/libraries/harness/linear/creation-policy.md":D,"../../../../../contributors/synasapmob/libraries/harness/linear/delivery-readiness.md":O,"../../../../../contributors/synasapmob/libraries/harness/linear/freshness-report-summary.md":k,"../../../../../contributors/synasapmob/libraries/harness/linear/report-summary.md":A,"../../../../../contributors/synasapmob/libraries/harness/linear/requirements-freshness.md":j,"../../../../../contributors/synasapmob/libraries/harness/playwright/report-summary.md":M,"../../../../../contributors/synasapmob/libraries/harness/projects/registry.yaml":N,"../../../../../contributors/synasapmob/libraries/harness/projects/routing.md":P,"../../../../../contributors/synasapmob/libraries/hooks/supabase-routing.md":F,"../../../../../contributors/synasapmob/libraries/templates/github-pull-request.md":I,"../../../../../contributors/synasapmob/libraries/templates/linear-issue.md":L})).map(([e,t])=>[e.replace(/^.*\/contributors\//,`/contributors/`),t])),Pe=Object.fromEntries(Object.entries(Object.assign({"../../../scripts/machine/registries/mcp/chrome-devtools.toml":_e,"../../../scripts/machine/registries/mcp/linear.toml":ve,"../../../scripts/machine/registries/mcp/notion.toml":ye,"../../../scripts/machine/registries/mcp/playwright.toml":be,"../../../scripts/machine/registries/mcp/supabase-hub-william.toml":xe,"../../../scripts/machine/registries/mcp/supabase-sonix-study.toml":Se})).map(([e,t])=>[e.replace(/^.*\/scripts\/machine\//,`/scripts/machine/`),t])),Fe={libraries:`library`,tools:`tools`};function Ie(e){if(!e.endsWith(`.md`))return null;let t=e.replace(/^\//,``).split(`/`);if(t[0]!==ke)return null;let n=t[1]??``;if(!n)return null;let r=n===B?null:n,i=t.slice(2),a=Fe[i[0]??``],o=i[1]??``;if(!a||!o)return null;let s=je[o]??o,c=i.slice(2);return c.length===0?null:s===`skills`?c.length!==2||c.at(-1)!==`SKILL.md`?null:{section:a,category:s,group:o,contributor:r}:c.length===1&&c[0]===`AGENTS.md`?null:{section:a,category:s,group:c.length===1?o:c[0]??o,contributor:r}}var Le=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?/;function Re(e){let t=Le.exec(e);if(!t)return{frontMatter:{},body:e.trim()};let n={};for(let e of t[1].split(`
`)){let t=e.indexOf(`:`);t!==-1&&(n[e.slice(0,t).trim()]=e.slice(t+1).trim())}return{frontMatter:n,body:e.slice(t[0].length).trim()}}function H(e){return e.replace(/[`[\]]/g,``).trim()}function ze(e,t){let n=/^#\s+(.+)$/m.exec(e)?.[1];if(n)return H(n);let r=t.replace(/[-_]/g,` `);return r.charAt(0).toUpperCase()+r.slice(1)}function Be(e){let t=e.replace(/^#\s+.+\n/,``).split(/\n\s*\n/).map(e=>e.trim()).filter(e=>e.length>0);return(t.find(e=>!/^(#{1,6}\s|\||```|[-*]\s|\d+\.\s|`)/.test(e))??t[0]??``).replace(/\s+/g,` `)}function Ve(){let e=[];for(let[t,n]of Object.entries(V)){let r=Ie(t);if(!r)continue;let i=t.replace(/^\//,``).replace(/\.md$/,``),{body:a,frontMatter:o}=Re(n),s=i.split(`/`).at(-1)??i;e.push({id:i,slug:i.replace(/\//g,`-`),name:o.name??ze(a,s),description:o.description??Be(a),section:r.section,category:r.category,group:r.group,contributor:r.contributor,source:n,lineCount:a.split(`
`).length})}return e.sort((e,t)=>e.id.localeCompare(t.id))}var U=Ve();function He(e){return R({path:e.id,section:e.section,category:e.category,group:e.group})}function W(e,t=null){let n=new Map;for(let r of U){if(r.section!==e||r.contributor!==t)continue;let i=He(r),a=n.get(i)??[];a.push(r),n.set(i,a)}return[...n.entries()].sort(([t],[n])=>Oe(e,t,n)).map(([n,r])=>({id:n,...De(n),section:e,contributor:t,entries:r}))}function Ue(e,t,n=null){return e?W(t,n).find(t=>t.id===e.toLowerCase())??null:null}function We(e,t){let n=t.trim().toLowerCase();return!n||e.label.toLowerCase().includes(n)||e.summary.toLowerCase().includes(n)||e.entries.some(e=>G(e,t))}function Ge(e){let t=`/contributors/${e.contributor??B}/`;return Object.entries(V).filter(([n])=>n.startsWith(t)&&z(n)===e.id).sort(([e],[t])=>e.localeCompare(t)).map(([e,t])=>{let n=e.replace(/^\/+/,``),r=n.split(`/`).at(-1)??n,i=U.find(e=>`${e.id}.md`===n);return{path:n,url:J(n),name:r,title:i?.name??r,description:i?.description??`Supporting file required by this collection.`,source:t}})}function Ke(e,t=null){return U.filter(n=>n.category===e&&n.contributor===t)}function qe(e){return[...new Set(U.filter(t=>!e||t.section===e).map(e=>e.contributor).filter(e=>e!==null))].sort()}function Je(e){return e?U.find(t=>t.slug===e)??null:null}function G(e,t){let n=t.trim().toLowerCase();return!n||e.name.toLowerCase().includes(n)||e.description.toLowerCase().includes(n)||e.group.toLowerCase().includes(n)||e.id.toLowerCase().includes(n)}var K=`https://synasapmob.github.io`,Ye=`catalog`;function q(e,t){return`${t??(typeof window>`u`?K:window.location.origin)}/hub-william/dev/${e.replace(/^\/+/,``)}`}function J(e){return q(`${Ye}/${e}`)}function Xe(e){return q(`install.py`,e)}function Ze(e){return q(`gateway.py`,e)}function Qe(e){return J(`${e.id}.md`)}function $e(e){let t=e.contributor??B,n=`/contributors/${t}/`,r=Object.keys(V).filter(t=>t.startsWith(n)&&z(t)===e.id).length;return{name:`${e.id}.zip`,url:J(`collections/${t}/${e.section}/${e.id}.zip`),fileCount:r}}var Y=[`notion`,`linear`,`playwright`,`chrome-browser`,`supabase`],X={"chrome-browser":`Chrome Browser`,linear:`Linear`,notion:`Notion`,playwright:`Playwright`,supabase:`Supabase`};function et(e){return e===`chrome-devtools`?`chrome-browser`:e.startsWith(`supabase-`)?`supabase`:e}function tt(){let e=new Map;for(let[t,n]of Object.entries(Pe)){let r=(t.split(`/`).at(-1)??``).replace(/\.toml$/,``),i=et(r),a=/^description\s*=\s*"([^"]+)"/m.exec(n)?.[1]??`Install ${X[i]??i}.`,o=e.get(i);o?o.servers.push(r):e.set(i,{id:i,label:X[i]??Ne(i),description:a,servers:[r]})}return[...e.values()].sort((e,t)=>{let n=Y.indexOf(e.id),r=Y.indexOf(t.id);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:e.label.localeCompare(t.label)})}var Z=/^(#{1,6})\s+(.+)$/gm,nt=/`(\[[^`\]]+\])`/g;function Q(e){if(e.category===`skills`)return[`/${e.name}`];let t=[];for(let[,,n]of e.source.matchAll(Z))for(let[,e]of n.matchAll(nt))t.includes(e)||t.push(e);return t}function rt(e){let t=[];for(let[,n,r]of e.source.matchAll(Z))n.length===2&&t.push(H(r));return t}function it(e){return{destination:`~/.hub-william/${e.id}.md`,invocations:Q(e),sections:rt(e)}}function at(e,t){return U.filter(n=>n.section===e&&n.contributor===t)}function ot(e=`library`,t=null){return at(e,t).length}var $={collectionArchive:$e,collectionFiles:Ge,collectionsInSection:W,contributors:qe,documentCount:ot,documentUrl:Qe,findBySlug:Je,findCollection:Ue,gatewayInstallerUrl:Ze,installerUrl:Xe,listEntriesByCategory:Ke,matchesCollectionQuery:We,mcpProducts:tt,matchesQuery:G,usage:it,publishedSiteOrigin:K};function st({command:e}){let[t,n]=(0,l.useState)(!1);(0,l.useEffect)(()=>{if(!t)return;let e=setTimeout(()=>n(!1),2e3);return()=>clearTimeout(e)},[t]);async function r(){n(await o(e))}return(0,u.jsxs)(s,{className:`items-center justify-between gap-2 rounded-lg border border-zinc-800 bg-zinc-950 p-2.5 font-mono text-xs text-zinc-100`,children:[(0,u.jsxs)(`code`,{className:`flex min-w-0 items-center gap-2 overflow-x-auto`,children:[(0,u.jsx)(`span`,{"aria-hidden":`true`,className:`text-zinc-500 select-none`,children:`$`}),e]}),(0,u.jsxs)(`button`,{type:`button`,onClick:()=>void r(),className:`flex shrink-0 items-center gap-1 rounded px-1 text-[11px] text-zinc-400 transition-colors hover:text-zinc-100 focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:outline-hidden`,children:[t?(0,u.jsx)(a,{"aria-hidden":`true`,className:`size-3.5 text-emerald-400`}):(0,u.jsx)(i,{"aria-hidden":`true`,className:`size-3.5`}),t?`Copied`:`Copy`]})]})}function ct({source:e}){let[t,n]=(0,l.useState)(!1);(0,l.useEffect)(()=>{if(!t)return;let e=setTimeout(()=>n(!1),2e3);return()=>clearTimeout(e)},[t]);async function r(){n(await o(e))}return(0,u.jsxs)(`div`,{className:`relative`,children:[(0,u.jsx)(`pre`,{className:`max-h-160 overflow-y-auto rounded-xl border border-zinc-800 bg-zinc-950 p-4 pt-12 font-mono text-[11px] leading-relaxed wrap-break-word whitespace-pre-wrap text-zinc-100`,children:(0,u.jsx)(`code`,{children:e})}),(0,u.jsxs)(`button`,{type:`button`,onClick:()=>void r(),className:`absolute top-3 right-3 flex items-center gap-1.5 rounded-lg border border-zinc-700 bg-zinc-900/90 px-2.5 py-1.5 font-mono text-[11px] text-zinc-200 backdrop-blur-xs transition-colors hover:bg-zinc-800 focus-visible:ring-2 focus-visible:ring-zinc-500 focus-visible:outline-hidden`,children:[t?(0,u.jsx)(a,{"aria-hidden":`true`,className:`size-3.5 text-emerald-400`}):(0,u.jsx)(i,{"aria-hidden":`true`,className:`size-3.5`}),t?`Copied`:`Copy`]})]})}var lt=()=>()=>{},ut=()=>window.location.origin,dt=()=>$.publishedSiteOrigin;function ft(){return(0,l.useSyncExternalStore)(lt,ut,dt)}export{$ as a,Ae as i,ct as n,c as o,st as r,ft as t};