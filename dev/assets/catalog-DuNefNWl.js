...
`,ce=`# Requirements freshness history
...
`,_=`# Downloading a document instead
...
labeled \`not created\`.
`,S=`# Existing Linear delivery readiness
...
`,T=`# Existing Linear requirements freshness gate
...
-->
`,j=`# Linear delivery issue template
...
-->
`,M=`contributors`,N=`default`,P=`https://github.com/synasapmob/hub-william`,F=[`harness`,`skills`,`templates`],I={hooks:`harness`},L={github:`GitHub`,mcp:`MCP`,harness:`Harnesses`};function R(e){let t=L[e];if(t)return t;let n=e.replace(/[-_]/g,` `);return n.charAt(0).toUpperCase()+n.slice(1)}var z={harness:`Execution modes and the contracts around them. A tag the operator types, or a supporting contract that fires before a write leaves the checkout, whether or not a tag asked for it.`,skills:`Cognitive capabilities loaded on demand. A skill carries the rules for one discipline and the reading order that makes them apply.`,templates:`The shapes the workspace writes into: approach histories, test evidence, pull requests and issues, so two agents produce the same artefact.`,installer:`Getting the catalogue onto a machine, and what happens to it afterwards. The program is in this repository so you can read it before you run it.`,mcp:`Registering Model Context Protocol servers across the agents that use them, in each agent's own configuration format.`};function B(e){return z[e]??``}function V(e){return R(e).toUpperCase()}var H=Object.assign({"/contributors/default/libraries/harness/AGENTS.md":e,"/contributors/default/libraries/harness/evidence/approach-history.md":t,"/contributors/default/libraries/harness/evidence/report-summary.md":n,"/contributors/default/libraries/harness/evidence/test-evidence.md":r,"/contributors/default/libraries/harness/github/clickable-references.md":i,"/contributors/default/libraries/harness/github/gh-cli.md":a,"/contributors/default/libraries/harness/github/report-summary.md":o,"/contributors/default/libraries/harness/tags/answer.md":s,"/contributors/default/libraries/harness/tags/delivery-verify.md":c,"/contributors/default/libraries/harness/tags/delivery.md":l,"/contributors/default/libraries/harness/tags/draft.md":u,"/contributors/default/libraries/harness/tags/ignore.md":d,"/contributors/default/libraries/harness/tags/linear.md":f,"/contributors/default/libraries/harness/tags/merge.md":p,"/contributors/default/libraries/harness/tags/mergeable.md":ee,"/contributors/default/libraries/harness/tags/plan.md":te,"/contributors/default/libraries/harness/tags/playwright.md":ne,"/contributors/default/libraries/harness/tags/rebase.md":re,"/contributors/default/libraries/harness/tags/report.md":ie,"/contributors/default/libraries/harness/tags/worktree.md":m,"/contributors/default/libraries/skills/frontend-convention/SKILL.md":h,"/contributors/default/libraries/skills/frontend-convention/references/frontend-conventions.md":g,"/contributors/default/libraries/skills/frontend-verify/SKILL.md":ae,"/contributors/default/libraries/skills/supabase-remote/SKILL.md":oe,"/contributors/default/libraries/templates/approach-history.md":se,"/contributors/default/libraries/templates/requirements-freshness.md":ce,"/contributors/default/libraries/templates/test-evidence.md":le,"/contributors/default/tools/installer/download-and-inject.md":_,"/contributors/default/tools/installer/machine-installer.md":v,"/contributors/default/tools/mcp/mcp-servers.md":y,"/contributors/synasapmob/libraries/harness/dopa-tps.md":b,"/contributors/synasapmob/libraries/harness/linear/creation-policy.md":x,"/contributors/synasapmob/libraries/harness/linear/delivery-readiness.md":S,"/contributors/synasapmob/libraries/harness/linear/freshness-report-summary.md":C,"/contributors/synasapmob/libraries/harness/linear/report-summary.md":w,"/contributors/synasapmob/libraries/harness/linear/requirements-freshness.md":T,"/contributors/synasapmob/libraries/harness/playwright/report-summary.md":E,"/contributors/synasapmob/libraries/harness/projects/registry.yaml":D,"/contributors/synasapmob/libraries/harness/projects/routing.md":O,"/contributors/synasapmob/libraries/hooks/supabase-routing.md":k,"/contributors/synasapmob/libraries/templates/github-pull-request.md":A,"/contributors/synasapmob/libraries/templates/linear-issue.md":j}),U={libraries:`library`,tools:`tools`};function W(e){return Object.keys(U).find(t=>U[t]===e)??e}function ue(e){if(!e.endsWith(`.md`))return null;let t=e.replace(/^\//,``).split(`/`);if(t[0]!==M)return null;let n=t[1]??``;if(!n)return null;let r=n===N?null:n,i=t.slice(2),a=U[i[0]??``],o=i[1]??``;if(!a||!o)return null;let s=I[o]??o,c=i.slice(2);return c.length===0?null:s===`skills`?c.length!==2||c.at(-1)!==`SKILL.md`?null:{section:a,category:s,group:o,contributor:r}:c.length===1&&c[0]===`AGENTS.md`?null:{section:a,category:s,group:c.length===1?o:c[0]??o,contributor:r}}var de=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?/;function G(e){let t=de.exec(e);if(!t)return{frontMatter:{},body:e.trim()};let n={};for(let e of t[1].split(`
`)){let t=e.indexOf(`:`);t!==-1&&(n[e.slice(0,t).trim()]=e.slice(t+1).trim())}return{frontMatter:n,body:e.slice(t[0].length).trim()}}function K(e){return e.replace(/[`[\]]/g,``).trim()}function fe(e,t){let n=/^#\s+(.+)$/m.exec(e)?.[1];if(n)return K(n);let r=t.replace(/[-_]/g,` `);return r.charAt(0).toUpperCase()+r.slice(1)}function pe(e){let t=e.replace(/^#\s+.+\n/,``).split(/\n\s*\n/).map(e=>e.trim()).filter(e=>e.length>0);return(t.find(e=>!/^(#{1,6}\s|\||```|[-*]\s|\d+\.\s|`)/.test(e))??t[0]??``).replace(/\s+/g,` `)}function me(e){return e.replace(/^#\s+.+(\r?\n)+/,``)}function he(){let e=[];for(let[t,n]of Object.entries(H)){let r=ue(t);if(!r)continue;let i=t.replace(/^\//,``).replace(/\.md$/,``),{body:a,frontMatter:o}=G(n),s=i.split(`/`).at(-1)??i;e.push({id:i,slug:i.replace(/\//g,`-`),name:o.name??fe(a,s),description:o.description??pe(a),section:r.section,category:r.category,group:r.group,contributor:r.contributor,body:me(a),source:n,lineCount:a.split(`
`).length})}return e.sort((e,t)=>e.id.localeCompare(t.id))}var q=he();function J(e,t=null){return q.filter(n=>n.category===e&&n.contributor===t)}function Y(e,t=null){let n=[...new Set(q.filter(n=>n.section===e&&n.contributor===t).map(e=>e.category))];return e===`library`?[...F.filter(e=>n.includes(e)),...n.filter(e=>!F.includes(e))]:n.sort()}function ge(e){return[...new Set(q.filter(t=>!e||t.section===e).map(e=>e.contributor).filter(e=>e!==null))].sort()}function _e(e){return e?q.find(t=>t.slug===e)??null:null}function ve(e,t=`library`,n=null){let r=e?.toLowerCase();return Y(t,n).find(e=>e.toLowerCase()===r)??null}function ye(e,t=null){let n=e;return[...new Set(J(e,t).map(e=>e.group))].sort((e,t)=>e===n?-1:t===n?1:e.localeCompare(t))}function be(e,t){let n=t.trim().toLowerCase();return!n||e.name.toLowerCase().includes(n)||e.description.toLowerCase().includes(n)||e.group.toLowerCase().includes(n)||e.id.toLowerCase().includes(n)}function xe(e){return`${e.id.split(`/`).at(-1)}.md`}function Se(e){return`${P}/blob/main/${e.id}.md`}var Ce=`https://synasapmob.github.io`,we=`catalog`;function X(e){return`${typeof window>`u`?Ce:window.location.origin}/hub-william/dev/${we}/${e}`}function Te(e){return X(`${e.id}.md`)}function Z(e){return{name:`${e.split(`/`).at(-1)}.zip`,url:X(`${e}.zip`),fileCount:Object.keys(H).filter(t=>t.startsWith(`/${e}/`)).length}}function Ee(e){return Z(e.id.split(`/`).slice(0,4).join(`/`))}function De(e,t=null){return Z(`${M}/${t??N}/${W(e)}`)}function Oe(){return Z(M)}function ke(){return X(`index.json`)}var Q=/^(#{1,6})\s+(.+)$/gm,Ae=/`(\[[^`\]]+\])`/g;function je(e){if(e.category===`skills`)return[`/${e.name}`];let t=[];for(let[,,n]of e.source.matchAll(Q))for(let[,e]of n.matchAll(Ae))t.includes(e)||t.push(e);return t}function Me(e){let t=[];for(let[,n,r]of e.source.matchAll(Q))n.length===2&&t.push(K(r));return t}function Ne(e){return{destination:`~/.hub-william/${e.id}.md`,invocations:je(e),sections:Me(e)}}function Pe(e){return`${P}/new/main/${M}/${e.contributor??N}/${W(e.section)}/${e.category}`}function $(e,t){return q.filter(n=>n.section===e&&n.contributor===t)}function Fe(e=`library`,t=null){return $(e,t).length}function Ie(e=`library`,t=null){return new Set($(e,t).map(e=>e.group)).size}var Le={catalogArchive:Oe,contributors:ge,fileName:xe,contributeUrl:Pe,documentCount:Fe,documentUrl:Te,findBySlug:_e,findCategory:ve,groupCount:Ie,groupsInCategory:ye,indexUrl:ke,listEntriesByCategory:J,rootArchive:Ee,rootsInSection:Y,matchesQuery:be,sectionArchive:De,sourceUrl:Se,usage:Ne};export{B as a,V as i,Le as n,R as r,P as t};