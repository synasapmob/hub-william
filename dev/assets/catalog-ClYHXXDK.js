...
`,oe=`# Frontend convention baseline
...
-->
`,P=`contributors`,F=`default`,I=`https://github.com/synasapmob/hub-william`,L=[`harness`,`skills`,`templates`],R={hooks:`harness`},z={github:`GitHub`,mcp:`MCP`,harness:`Harnesses`};function B(e){let t=z[e];if(t)return t;let n=e.replace(/[-_]/g,` `);return n.charAt(0).toUpperCase()+n.slice(1)}var V={harness:`Execution modes and the contracts around them. A tag the operator types, or a supporting contract that fires before a write leaves the checkout, whether or not a tag asked for it.`,skills:`Cognitive capabilities loaded on demand. A skill carries the rules for one discipline and the reading order that makes them apply.`,templates:`The shapes the workspace writes into: approach histories, test evidence, pull requests and issues, so two agents produce the same artefact.`,installer:`Getting the catalogue onto a machine, and what happens to it afterwards. The program is in this repository so you can read it before you run it.`,mcp:`Registering Model Context Protocol servers across the agents that use them, in each agent's own configuration format.`};function H(e){return V[e]??``}function U(e){return B(e).toUpperCase()}var W=Object.assign({"/contributors/default/libraries/harness/AGENTS.md":e,"/contributors/default/libraries/harness/evidence/approach-history.md":t,"/contributors/default/libraries/harness/evidence/report-summary.md":n,"/contributors/default/libraries/harness/evidence/test-evidence.md":r,"/contributors/default/libraries/harness/github/clickable-references.md":i,"/contributors/default/libraries/harness/github/gh-cli.md":a,"/contributors/default/libraries/harness/github/report-summary.md":o,"/contributors/default/libraries/harness/tags/answer.md":s,"/contributors/default/libraries/harness/tags/delivery-verify.md":c,"/contributors/default/libraries/harness/tags/delivery.md":l,"/contributors/default/libraries/harness/tags/draft.md":u,"/contributors/default/libraries/harness/tags/guess.md":ee,"/contributors/default/libraries/harness/tags/ignore.md":te,"/contributors/default/libraries/harness/tags/linear.md":ne,"/contributors/default/libraries/harness/tags/merge.md":re,"/contributors/default/libraries/harness/tags/mergeable.md":d,"/contributors/default/libraries/harness/tags/plan.md":f,"/contributors/default/libraries/harness/tags/playwright.md":p,"/contributors/default/libraries/harness/tags/rebase.md":m,"/contributors/default/libraries/harness/tags/report.md":h,"/contributors/default/libraries/harness/tags/worktree.md":ie,"/contributors/default/libraries/skills/frontend-convention/SKILL.md":ae,"/contributors/default/libraries/skills/frontend-convention/references/frontend-conventions.md":oe,"/contributors/default/libraries/skills/frontend-verify/SKILL.md":se,"/contributors/default/libraries/skills/supabase-remote/SKILL.md":ce,"/contributors/default/libraries/templates/approach-history.md":g,"/contributors/default/libraries/templates/requirements-freshness.md":_,"/contributors/default/libraries/templates/test-evidence.md":v,"/contributors/default/tools/installer/download-and-inject.md":y,"/contributors/default/tools/installer/machine-installer.md":b,"/contributors/default/tools/mcp/mcp-servers.md":x,"/contributors/synasapmob/libraries/harness/dopa-tps.md":S,"/contributors/synasapmob/libraries/harness/linear/creation-policy.md":C,"/contributors/synasapmob/libraries/harness/linear/delivery-readiness.md":w,"/contributors/synasapmob/libraries/harness/linear/freshness-report-summary.md":T,"/contributors/synasapmob/libraries/harness/linear/report-summary.md":E,"/contributors/synasapmob/libraries/harness/linear/requirements-freshness.md":D,"/contributors/synasapmob/libraries/harness/playwright/report-summary.md":O,"/contributors/synasapmob/libraries/harness/projects/registry.yaml":k,"/contributors/synasapmob/libraries/harness/projects/routing.md":A,"/contributors/synasapmob/libraries/hooks/supabase-routing.md":j,"/contributors/synasapmob/libraries/templates/github-pull-request.md":M,"/contributors/synasapmob/libraries/templates/linear-issue.md":N}),G={libraries:`library`,tools:`tools`};function le(e){return Object.keys(G).find(t=>G[t]===e)??e}function ue(e){if(!e.endsWith(`.md`))return null;let t=e.replace(/^\//,``).split(`/`);if(t[0]!==P)return null;let n=t[1]??``;if(!n)return null;let r=n===F?null:n,i=t.slice(2),a=G[i[0]??``],o=i[1]??``;if(!a||!o)return null;let s=R[o]??o,c=i.slice(2);return c.length===0?null:s===`skills`?c.length!==2||c.at(-1)!==`SKILL.md`?null:{section:a,category:s,group:o,contributor:r}:c.length===1&&c[0]===`AGENTS.md`?null:{section:a,category:s,group:c.length===1?o:c[0]??o,contributor:r}}var de=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?/;function fe(e){let t=de.exec(e);if(!t)return{frontMatter:{},body:e.trim()};let n={};for(let e of t[1].split(`
`)){let t=e.indexOf(`:`);t!==-1&&(n[e.slice(0,t).trim()]=e.slice(t+1).trim())}return{frontMatter:n,body:e.slice(t[0].length).trim()}}function K(e){return e.replace(/[`[\]]/g,``).trim()}function pe(e,t){let n=/^#\s+(.+)$/m.exec(e)?.[1];if(n)return K(n);let r=t.replace(/[-_]/g,` `);return r.charAt(0).toUpperCase()+r.slice(1)}function me(e){let t=e.replace(/^#\s+.+\n/,``).split(/\n\s*\n/).map(e=>e.trim()).filter(e=>e.length>0);return(t.find(e=>!/^(#{1,6}\s|\||```|[-*]\s|\d+\.\s|`)/.test(e))??t[0]??``).replace(/\s+/g,` `)}function he(e){return e.replace(/^#\s+.+(\r?\n)+/,``)}function ge(){let e=[];for(let[t,n]of Object.entries(W)){let r=ue(t);if(!r)continue;let i=t.replace(/^\//,``).replace(/\.md$/,``),{body:a,frontMatter:o}=fe(n),s=i.split(`/`).at(-1)??i;e.push({id:i,slug:i.replace(/\//g,`-`),name:o.name??pe(a,s),description:o.description??me(a),section:r.section,category:r.category,group:r.group,contributor:r.contributor,body:he(a),source:n,lineCount:a.split(`
`).length})}return e.sort((e,t)=>e.id.localeCompare(t.id))}var q=ge();function J(e,t=null){return q.filter(n=>n.category===e&&n.contributor===t)}function Y(e,t=null){let n=[...new Set(q.filter(n=>n.section===e&&n.contributor===t).map(e=>e.category))];return e===`library`?[...L.filter(e=>n.includes(e)),...n.filter(e=>!L.includes(e))]:n.sort()}function _e(e){return[...new Set(q.filter(t=>!e||t.section===e).map(e=>e.contributor).filter(e=>e!==null))].sort()}function ve(e){return e?q.find(t=>t.slug===e)??null:null}function ye(e,t){let n=t.split(/[?#]/,1)[0]?.replace(/\\/g,`/`)??``;if(!n.endsWith(`.md`)||/^[a-z][a-z\d+.-]*:/i.test(n))return null;let r=/(?:^|\/)contributors\/([^/]+)\/(?:contributors\/default\/)?(.+)$/.exec(n),i=r?`contributors/${r[1]}/${r[2]}`:`${e.id.split(`/`).slice(0,-1).join(`/`)}/${n}`,a=[];for(let e of i.split(`/`))!e||e===`.`||e===`~`||(e===`..`?a.pop():a.push(e));let o=a.join(`/`).replace(/\.md$/,``);return q.find(e=>e.id===o)??null}function be(e,t=`library`,n=null){let r=e?.toLowerCase();return Y(t,n).find(e=>e.toLowerCase()===r)??null}function xe(e,t=null){let n=e;return[...new Set(J(e,t).map(e=>e.group))].sort((e,t)=>e===n?-1:t===n?1:e.localeCompare(t))}function Se(e,t){let n=t.trim().toLowerCase();return!n||e.name.toLowerCase().includes(n)||e.description.toLowerCase().includes(n)||e.group.toLowerCase().includes(n)||e.id.toLowerCase().includes(n)}function Ce(e){return`${e.id.split(`/`).at(-1)}.md`}function we(e){return`${I}/blob/main/${e.id}.md`}var Te=`https://synasapmob.github.io`,Ee=`catalog`;function X(e){return`${typeof window>`u`?Te:window.location.origin}/hub-william/dev/${Ee}/${e}`}function De(e){return X(`${e.id}.md`)}function Oe(e){return{name:`${e.split(`/`).at(-1)}.zip`,url:X(`${e}.zip`),fileCount:Object.keys(W).filter(t=>t.startsWith(`/${e}/`)).length}}function Z(e){return Oe(e.id.split(`/`).slice(0,4).join(`/`))}var Q=/^(#{1,6})\s+(.+)$/gm,ke=/`(\[[^`\]]+\])`/g;function Ae(e){if(e.category===`skills`)return[`/${e.name}`];let t=[];for(let[,,n]of e.source.matchAll(Q))for(let[,e]of n.matchAll(ke))t.includes(e)||t.push(e);return t}function je(e){let t=[];for(let[,n,r]of e.source.matchAll(Q))n.length===2&&t.push(K(r));return t}function Me(e){return{destination:`~/.hub-william/${e.id}.md`,invocations:Ae(e),sections:je(e)}}function Ne(e){return`${I}/new/main/${P}/${e.contributor??F}/${le(e.section)}/${e.category}`}function $(e,t){return q.filter(n=>n.section===e&&n.contributor===t)}function Pe(e=`library`,t=null){return $(e,t).length}function Fe(e=`library`,t=null){return new Set($(e,t).map(e=>e.group)).size}var Ie={contributors:_e,fileName:Ce,contributeUrl:Ne,documentCount:Pe,documentUrl:De,findBySlug:ve,findMarkdownReference:ye,findCategory:be,groupCount:Fe,groupsInCategory:xe,listEntriesByCategory:J,rootArchive:Z,rootsInSection:Y,matchesQuery:Se,sourceUrl:we,usage:Me};export{H as a,U as i,Ie as n,B as r,I as t};