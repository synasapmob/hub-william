...
`,de=`# Frontend convention baseline
...
`,d=`# Requirements freshness history
...
`,p=`# Downloading a document instead
...
`,v=`# Existing Linear delivery readiness
...
`,x=`# Existing Linear requirements freshness gate
...
-->
`,D=`# Linear delivery issue template
...
-->
`,O=`description = "Chrome DevTools: console, network and performance traces."
command = "npx"
args = ["-y", "chrome-devtools-mcp"]
`,k=`description = "Linear issues and projects. OAuth: run \`./install.sh mcp auth linear\`."
url = "https://mcp.linear.app/mcp"
`,A=`description = "Notion pages and databases. OAuth: run \`./install.sh mcp auth notion\`."
url = "https://mcp.notion.com/mcp"
`,j=`description = "Drive a real browser to verify frontend changes."
command = "npx"
args = ["-y", "@playwright/mcp@latest"]
`,M=`# hub-william's Postgres, and the only way in. There is no \`sb-*\` wrapper any
...
`,N=`# sonix-study's Postgres. Same shape as supabase-hub-william.toml, which
...
`,P=new Set([`draft`,`merge`,`mergeable`,`rebase`]),F={documents:{label:`Documents`,summary:`Install the catalogue globally or add its managed rules to one project.`},evidences:{label:`Evidences`,summary:`Contracts for recording approaches, test runs and the evidence behind a handoff.`},github:{label:`GitHub`,summary:`Git, pull request and GitHub contracts, including merge, mergeability, draft and rebase workflows.`},mcp:{label:`MCP`,summary:`Register the supported MCP servers across the agents installed on this machine.`},skills:{label:`Skills`,summary:`Focused capabilities loaded when a task matches, with their supporting references kept together.`},tags:{label:`Tags`,summary:`Prompt tokens that select an execution mode or modify how a task is handled.`},templates:{label:`Templates`,summary:`Reusable shapes for issues, pull requests, evidence and implementation histories.`}},I={library:[`evidences`,`github`,`tags`,`skills`,`templates`],tools:[`documents`,`mcp`]};function L(e){return(e.split(`/`).at(-1)??e).replace(/\.[^.]+$/,``)}function R(e){return e.section===`tools`?e.category===`installer`?`documents`:e.category:e.group===`evidence`?`evidences`:e.group===`github`||e.group===`tags`&&P.has(L(e.path))?`github`:e.group===`tags`?`tags`:e.category===`skills`?`skills`:e.category===`templates`?`templates`:e.group||e.category}function z(e){let t=e.replace(/^\/+/,``).split(`/`);if(t[0]!==`contributors`||t.length<4)return null;let n=t[2],r=n===`libraries`?`library`:n===`tools`?`tools`:null;if(!r)return null;let i=t[3]??``,a=t.slice(4);if(r===`library`&&i===`harness`&&a[0]===`AGENTS.md`)return`tags`;let o=i===`hooks`?`harness`:i,s=i;return o===`skills`||o===`templates`?s=o:a.length>1&&(s=a[0]??i),R({path:e,section:r,category:o,group:s})}function he(e){let t=F[e];if(t)return t;let n=e.replace(/[-_]/g,` `),r=n.charAt(0).toUpperCase()+n.slice(1);return{label:r,summary:`Documents collected around ${r.toLowerCase()}.`}}function ge(e,t,n){let r=I[e],i=r.indexOf(t),a=r.indexOf(n);return i!==-1||a!==-1?i===-1?1:a===-1?-1:i-a:t.localeCompare(n)}var _e=`contributors`,B=`default`,ve=`https://github.com/synasapmob/hub-william`,ye={hooks:`harness`},be={github:`GitHub`,mcp:`MCP`,harness:`Harnesses`};function xe(e){let t=be[e];if(t)return t;let n=e.replace(/[-_]/g,` `);return n.charAt(0).toUpperCase()+n.slice(1)}var V=Object.fromEntries(Object.entries(Object.assign({"../../../../contributors/default/libraries/harness/AGENTS.md":e,"../../../../contributors/default/libraries/harness/evidence/approach-history.md":t,"../../../../contributors/default/libraries/harness/evidence/report-summary.md":n,"../../../../contributors/default/libraries/harness/evidence/test-evidence.md":r,"../../../../contributors/default/libraries/harness/github/clickable-references.md":i,"../../../../contributors/default/libraries/harness/github/gh-cli.md":a,"../../../../contributors/default/libraries/harness/github/report-summary.md":o,"../../../../contributors/default/libraries/harness/tags/answer.md":s,"../../../../contributors/default/libraries/harness/tags/delivery-verify.md":c,"../../../../contributors/default/libraries/harness/tags/delivery.md":l,"../../../../contributors/default/libraries/harness/tags/draft.md":u,"../../../../contributors/default/libraries/harness/tags/guess.md":ee,"../../../../contributors/default/libraries/harness/tags/ignore.md":te,"../../../../contributors/default/libraries/harness/tags/linear.md":ne,"../../../../contributors/default/libraries/harness/tags/merge.md":re,"../../../../contributors/default/libraries/harness/tags/mergeable.md":ie,"../../../../contributors/default/libraries/harness/tags/plan.md":ae,"../../../../contributors/default/libraries/harness/tags/playwright.md":oe,"../../../../contributors/default/libraries/harness/tags/rebase.md":se,"../../../../contributors/default/libraries/harness/tags/report.md":ce,"../../../../contributors/default/libraries/harness/tags/worktree.md":le,"../../../../contributors/default/libraries/skills/frontend-convention/SKILL.md":ue,"../../../../contributors/default/libraries/skills/frontend-convention/references/frontend-conventions.md":de,"../../../../contributors/default/libraries/skills/frontend-verify/SKILL.md":fe,"../../../../contributors/default/libraries/skills/supabase-remote/SKILL.md":pe,"../../../../contributors/default/libraries/templates/approach-history.md":me,"../../../../contributors/default/libraries/templates/requirements-freshness.md":d,"../../../../contributors/default/libraries/templates/test-evidence.md":f,"../../../../contributors/default/tools/installer/download-and-inject.md":p,"../../../../contributors/default/tools/installer/machine-installer.md":m,"../../../../contributors/default/tools/mcp/mcp-servers.md":h,"../../../../contributors/synasapmob/libraries/harness/dopa-tps.md":g,"../../../../contributors/synasapmob/libraries/harness/linear/creation-policy.md":_,"../../../../contributors/synasapmob/libraries/harness/linear/delivery-readiness.md":v,"../../../../contributors/synasapmob/libraries/harness/linear/freshness-report-summary.md":y,"../../../../contributors/synasapmob/libraries/harness/linear/report-summary.md":b,"../../../../contributors/synasapmob/libraries/harness/linear/requirements-freshness.md":x,"../../../../contributors/synasapmob/libraries/harness/playwright/report-summary.md":S,"../../../../contributors/synasapmob/libraries/harness/projects/registry.yaml":C,"../../../../contributors/synasapmob/libraries/harness/projects/routing.md":w,"../../../../contributors/synasapmob/libraries/hooks/supabase-routing.md":T,"../../../../contributors/synasapmob/libraries/templates/github-pull-request.md":E,"../../../../contributors/synasapmob/libraries/templates/linear-issue.md":D})).map(([e,t])=>[e.replace(/^.*\/contributors\//,`/contributors/`),t])),Se=Object.fromEntries(Object.entries(Object.assign({"../../../scripts/machine/registries/mcp/chrome-devtools.toml":O,"../../../scripts/machine/registries/mcp/linear.toml":k,"../../../scripts/machine/registries/mcp/notion.toml":A,"../../../scripts/machine/registries/mcp/playwright.toml":j,"../../../scripts/machine/registries/mcp/supabase-hub-william.toml":M,"../../../scripts/machine/registries/mcp/supabase-sonix-study.toml":N})).map(([e,t])=>[e.replace(/^.*\/scripts\/machine\//,`/scripts/machine/`),t])),Ce={libraries:`library`,tools:`tools`};function we(e){if(!e.endsWith(`.md`))return null;let t=e.replace(/^\//,``).split(`/`);if(t[0]!==_e)return null;let n=t[1]??``;if(!n)return null;let r=n===B?null:n,i=t.slice(2),a=Ce[i[0]??``],o=i[1]??``;if(!a||!o)return null;let s=ye[o]??o,c=i.slice(2);return c.length===0?null:s===`skills`?c.length!==2||c.at(-1)!==`SKILL.md`?null:{section:a,category:s,group:o,contributor:r}:c.length===1&&c[0]===`AGENTS.md`?null:{section:a,category:s,group:c.length===1?o:c[0]??o,contributor:r}}var Te=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?/;function Ee(e){let t=Te.exec(e);if(!t)return{frontMatter:{},body:e.trim()};let n={};for(let e of t[1].split(`
`)){let t=e.indexOf(`:`);t!==-1&&(n[e.slice(0,t).trim()]=e.slice(t+1).trim())}return{frontMatter:n,body:e.slice(t[0].length).trim()}}function H(e){return e.replace(/[`[\]]/g,``).trim()}function De(e,t){let n=/^#\s+(.+)$/m.exec(e)?.[1];if(n)return H(n);let r=t.replace(/[-_]/g,` `);return r.charAt(0).toUpperCase()+r.slice(1)}function Oe(e){let t=e.replace(/^#\s+.+\n/,``).split(/\n\s*\n/).map(e=>e.trim()).filter(e=>e.length>0);return(t.find(e=>!/^(#{1,6}\s|\||```|[-*]\s|\d+\.\s|`)/.test(e))??t[0]??``).replace(/\s+/g,` `)}function ke(){let e=[];for(let[t,n]of Object.entries(V)){let r=we(t);if(!r)continue;let i=t.replace(/^\//,``).replace(/\.md$/,``),{body:a,frontMatter:o}=Ee(n),s=i.split(`/`).at(-1)??i;e.push({id:i,slug:i.replace(/\//g,`-`),name:o.name??De(a,s),description:o.description??Oe(a),section:r.section,category:r.category,group:r.group,contributor:r.contributor,source:n,lineCount:a.split(`
`).length})}return e.sort((e,t)=>e.id.localeCompare(t.id))}var U=ke();function W(e){return R({path:e.id,section:e.section,category:e.category,group:e.group})}function G(e,t=null){let n=new Map;for(let r of U){if(r.section!==e||r.contributor!==t)continue;let i=W(r),a=n.get(i)??[];a.push(r),n.set(i,a)}return[...n.entries()].sort(([t],[n])=>ge(e,t,n)).map(([n,r])=>({id:n,...he(n),section:e,contributor:t,entries:r}))}function Ae(e,t,n=null){return e?G(t,n).find(t=>t.id===e.toLowerCase())??null:null}function je(e,t){let n=t.trim().toLowerCase();return!n||e.label.toLowerCase().includes(n)||e.summary.toLowerCase().includes(n)||e.entries.some(e=>K(e,t))}function Me(e){let t=`/contributors/${e.contributor??B}/`;return Object.entries(V).filter(([n])=>n.startsWith(t)&&z(n)===e.id).sort(([e],[t])=>e.localeCompare(t)).map(([e,t])=>{let n=e.replace(/^\/+/,``),r=n.split(`/`).at(-1)??n,i=U.find(e=>`${e.id}.md`===n);return{path:n,url:Y(n),name:r,title:i?.name??r,description:i?.description??`Supporting file required by this collection.`,source:t}})}function Ne(e,t=null){return U.filter(n=>n.category===e&&n.contributor===t)}function Pe(e){return[...new Set(U.filter(t=>!e||t.section===e).map(e=>e.contributor).filter(e=>e!==null))].sort()}function Fe(e){return e?U.find(t=>t.slug===e)??null:null}function K(e,t){let n=t.trim().toLowerCase();return!n||e.name.toLowerCase().includes(n)||e.description.toLowerCase().includes(n)||e.group.toLowerCase().includes(n)||e.id.toLowerCase().includes(n)}var q=`https://synasapmob.github.io`,Ie=`catalog`;function J(e,t){return`${t??(typeof window>`u`?q:window.location.origin)}/hub-william/dev/${e.replace(/^\/+/,``)}`}function Y(e){return J(`${Ie}/${e}`)}function Le(e){return J(`install.py`,e)}function X(e){return Y(`${e.id}.md`)}function Re(e){let t=e.contributor??B,n=`/contributors/${t}/`,r=Object.keys(V).filter(t=>t.startsWith(n)&&z(t)===e.id).length;return{name:`${e.id}.zip`,url:Y(`collections/${t}/${e.section}/${e.id}.zip`),fileCount:r}}var Z=[`notion`,`linear`,`playwright`,`chrome-browser`,`supabase`],Q={"chrome-browser":`Chrome Browser`,linear:`Linear`,notion:`Notion`,playwright:`Playwright`,supabase:`Supabase`};function ze(e){return e===`chrome-devtools`?`chrome-browser`:e.startsWith(`supabase-`)?`supabase`:e}function Be(){let e=new Map;for(let[t,n]of Object.entries(Se)){let r=(t.split(`/`).at(-1)??``).replace(/\.toml$/,``),i=ze(r),a=/^description\s*=\s*"([^"]+)"/m.exec(n)?.[1]??`Install ${Q[i]??i}.`,o=e.get(i);o?o.servers.push(r):e.set(i,{id:i,label:Q[i]??xe(i),description:a,servers:[r]})}return[...e.values()].sort((e,t)=>{let n=Z.indexOf(e.id),r=Z.indexOf(t.id);return n!==-1||r!==-1?n===-1?1:r===-1?-1:n-r:e.label.localeCompare(t.label)})}var $=/^(#{1,6})\s+(.+)$/gm,Ve=/`(\[[^`\]]+\])`/g;function He(e){if(e.category===`skills`)return[`/${e.name}`];let t=[];for(let[,,n]of e.source.matchAll($))for(let[,e]of n.matchAll(Ve))t.includes(e)||t.push(e);return t}function Ue(e){let t=[];for(let[,n,r]of e.source.matchAll($))n.length===2&&t.push(H(r));return t}function We(e){return{destination:`~/.hub-william/${e.id}.md`,invocations:He(e),sections:Ue(e)}}function Ge(e,t){return U.filter(n=>n.section===e&&n.contributor===t)}function Ke(e=`library`,t=null){return Ge(e,t).length}var qe={collectionArchive:Re,collectionFiles:Me,collectionsInSection:G,contributors:Pe,documentCount:Ke,documentUrl:X,findCollection:Ae,findBySlug:Fe,installerUrl:Le,listEntriesByCategory:Ne,matchesCollectionQuery:je,mcpProducts:Be,matchesQuery:K,usage:We,publishedSiteOrigin:q};export{qe as n,W as r,ve as t};