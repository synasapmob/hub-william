...
`,le=`# Frontend convention baseline
...
`,m=`# Requirements freshness history
...
`,g=`# Downloading a document instead
...
"""
`,S=`# synasapmob workflow selection
...
-->
`,F=`# Linear delivery issue template
...
-->
`,I=`# Codex workflow on synasapmob's devices
...
`,L=`contributors`,R=`default`,z=`https://github.com/synasapmob/hub-william`,B=[`harness`,`skills`,`templates`],V={hooks:`harness`},H={github:`GitHub`,mcp:`MCP`,harness:`Harnesses`};function U(e){let t=H[e];if(t)return t;let n=e.replace(/[-_]/g,` `);return n.charAt(0).toUpperCase()+n.slice(1)}var fe={harness:`Execution modes and the contracts around them. A tag the operator types, or a supporting contract that fires before a write leaves the checkout, whether or not a tag asked for it.`,skills:`Cognitive capabilities loaded on demand. A skill carries the rules for one discipline and the reading order that makes them apply.`,templates:`The shapes the workspace writes into: approach histories, test evidence, pull requests and issues, so two agents produce the same artefact.`,installer:`Getting the catalogue onto a machine, and what happens to it afterwards. The program is in this repository so you can read it before you run it.`,mcp:`Registering Model Context Protocol servers across the agents that use them, in each agent's own configuration format.`};function W(e){return fe[e]??``}function pe(e){return U(e).toUpperCase()}var G=Object.assign({"/contributors/default/libraries/harness/AGENTS.md":e,"/contributors/default/libraries/harness/evidence/approach-history.md":t,"/contributors/default/libraries/harness/evidence/report-summary.md":n,"/contributors/default/libraries/harness/evidence/test-evidence.md":r,"/contributors/default/libraries/harness/github/clickable-references.md":i,"/contributors/default/libraries/harness/github/gh-cli.md":a,"/contributors/default/libraries/harness/github/report-summary.md":o,"/contributors/default/libraries/harness/tags/answer.md":s,"/contributors/default/libraries/harness/tags/delivery-verify.md":c,"/contributors/default/libraries/harness/tags/delivery.md":l,"/contributors/default/libraries/harness/tags/draft.md":u,"/contributors/default/libraries/harness/tags/guess.md":ee,"/contributors/default/libraries/harness/tags/ignore.md":te,"/contributors/default/libraries/harness/tags/linear.md":ne,"/contributors/default/libraries/harness/tags/merge.md":re,"/contributors/default/libraries/harness/tags/mergeable.md":d,"/contributors/default/libraries/harness/tags/plan.md":f,"/contributors/default/libraries/harness/tags/playwright.md":ie,"/contributors/default/libraries/harness/tags/rebase.md":ae,"/contributors/default/libraries/harness/tags/report.md":oe,"/contributors/default/libraries/harness/tags/worktree.md":se,"/contributors/default/libraries/skills/frontend-convention/SKILL.md":ce,"/contributors/default/libraries/skills/frontend-convention/references/frontend-conventions.md":le,"/contributors/default/libraries/skills/frontend-verify/SKILL.md":ue,"/contributors/default/libraries/skills/supabase-remote/SKILL.md":de,"/contributors/default/libraries/templates/approach-history.md":p,"/contributors/default/libraries/templates/requirements-freshness.md":m,"/contributors/default/libraries/templates/test-evidence.md":h,"/contributors/default/tools/installer/download-and-inject.md":g,"/contributors/default/tools/installer/machine-installer.md":_,"/contributors/default/tools/mcp/mcp-servers.md":v,"/contributors/synasapmob/libraries/agents/codex/hub-reviewer.toml":y,"/contributors/synasapmob/libraries/agents/codex/hub-scout.toml":b,"/contributors/synasapmob/libraries/agents/codex/hub-verifier.toml":x,"/contributors/synasapmob/libraries/harness/AGENTS.md":S,"/contributors/synasapmob/libraries/harness/codex-policy.md":C,"/contributors/synasapmob/libraries/harness/dopa-tps.md":w,"/contributors/synasapmob/libraries/harness/linear/creation-policy.md":T,"/contributors/synasapmob/libraries/harness/linear/delivery-readiness.md":E,"/contributors/synasapmob/libraries/harness/linear/freshness-report-summary.md":D,"/contributors/synasapmob/libraries/harness/linear/report-summary.md":O,"/contributors/synasapmob/libraries/harness/linear/requirements-freshness.md":k,"/contributors/synasapmob/libraries/harness/playwright/report-summary.md":A,"/contributors/synasapmob/libraries/harness/projects/registry.yaml":j,"/contributors/synasapmob/libraries/harness/projects/routing.md":M,"/contributors/synasapmob/libraries/hooks/supabase-routing.md":N,"/contributors/synasapmob/libraries/templates/github-pull-request.md":P,"/contributors/synasapmob/libraries/templates/linear-issue.md":F,"/contributors/synasapmob/tools/installer/codex-workflow.md":I}),K={libraries:`library`,tools:`tools`};function me(e){return Object.keys(K).find(t=>K[t]===e)??e}function he(e){if(!e.endsWith(`.md`))return null;let t=e.replace(/^\//,``).split(`/`);if(t[0]!==L)return null;let n=t[1]??``;if(!n)return null;let r=n===R?null:n,i=t.slice(2),a=K[i[0]??``],o=i[1]??``;if(!a||!o)return null;let s=V[o]??o,c=i.slice(2);return c.length===0?null:s===`skills`?c.length!==2||c.at(-1)!==`SKILL.md`?null:{section:a,category:s,group:o,contributor:r}:c.length===1&&c[0]===`AGENTS.md`?null:{section:a,category:s,group:c.length===1?o:c[0]??o,contributor:r}}var ge=/^---\r?\n([\s\S]*?)\r?\n---\r?\n?/;function _e(e){let t=ge.exec(e);if(!t)return{frontMatter:{},body:e.trim()};let n={};for(let e of t[1].split(`
`)){let t=e.indexOf(`:`);t!==-1&&(n[e.slice(0,t).trim()]=e.slice(t+1).trim())}return{frontMatter:n,body:e.slice(t[0].length).trim()}}function q(e){return e.replace(/[`[\]]/g,``).trim()}function ve(e,t){let n=/^#\s+(.+)$/m.exec(e)?.[1];if(n)return q(n);let r=t.replace(/[-_]/g,` `);return r.charAt(0).toUpperCase()+r.slice(1)}function ye(e){let t=e.replace(/^#\s+.+\n/,``).split(/\n\s*\n/).map(e=>e.trim()).filter(e=>e.length>0);return(t.find(e=>!/^(#{1,6}\s|\||```|[-*]\s|\d+\.\s|`)/.test(e))??t[0]??``).replace(/\s+/g,` `)}function be(e){return e.replace(/^#\s+.+(\r?\n)+/,``)}function xe(){let e=[];for(let[t,n]of Object.entries(G)){let r=he(t);if(!r)continue;let i=t.replace(/^\//,``).replace(/\.md$/,``),{body:a,frontMatter:o}=_e(n),s=i.split(`/`).at(-1)??i;e.push({id:i,slug:i.replace(/\//g,`-`),name:o.name??ve(a,s),description:o.description??ye(a),section:r.section,category:r.category,group:r.group,contributor:r.contributor,body:be(a),source:n,lineCount:a.split(`
`).length})}return e.sort((e,t)=>e.id.localeCompare(t.id))}var J=xe();function Y(e,t=null){return J.filter(n=>n.category===e&&n.contributor===t)}function X(e,t=null){let n=[...new Set(J.filter(n=>n.section===e&&n.contributor===t).map(e=>e.category))];return e===`library`?[...B.filter(e=>n.includes(e)),...n.filter(e=>!B.includes(e))]:n.sort()}function Se(e){return[...new Set(J.filter(t=>!e||t.section===e).map(e=>e.contributor).filter(e=>e!==null))].sort()}function Ce(e){return e?J.find(t=>t.slug===e)??null:null}function we(e,t){let n=t.split(/[?#]/,1)[0]?.replace(/\\/g,`/`)??``;if(!n.endsWith(`.md`)||/^[a-z][a-z\d+.-]*:/i.test(n))return null;let r=/(?:^|\/)contributors\/([^/]+)\/(?:contributors\/default\/)?(.+)$/.exec(n),i=r?`contributors/${r[1]}/${r[2]}`:`${e.id.split(`/`).slice(0,-1).join(`/`)}/${n}`,a=[];for(let e of i.split(`/`))!e||e===`.`||e===`~`||(e===`..`?a.pop():a.push(e));let o=a.join(`/`).replace(/\.md$/,``);return J.find(e=>e.id===o)??null}function Te(e,t=`library`,n=null){let r=e?.toLowerCase();return X(t,n).find(e=>e.toLowerCase()===r)??null}function Ee(e,t=null){let n=e;return[...new Set(Y(e,t).map(e=>e.group))].sort((e,t)=>e===n?-1:t===n?1:e.localeCompare(t))}function De(e,t){let n=t.trim().toLowerCase();return!n||e.name.toLowerCase().includes(n)||e.description.toLowerCase().includes(n)||e.group.toLowerCase().includes(n)||e.id.toLowerCase().includes(n)}function Oe(e){return`${e.id.split(`/`).at(-1)}.md`}function ke(e){return`${z}/blob/main/${e.id}.md`}var Ae=`https://synasapmob.github.io`,je=`catalog`;function Z(e){return`${typeof window>`u`?Ae:window.location.origin}/hub-william/${je}/${e}`}function Me(e){return Z(`${e.id}.md`)}function Ne(e){return{name:`${e.split(`/`).at(-1)}.zip`,url:Z(`${e}.zip`),fileCount:Object.keys(G).filter(t=>t.startsWith(`/${e}/`)).length}}function Pe(e){return Ne(e.id.split(`/`).slice(0,4).join(`/`))}var Q=/^(#{1,6})\s+(.+)$/gm,Fe=/`(\[[^`\]]+\])`/g;function Ie(e){if(e.category===`skills`)return[`/${e.name}`];let t=[];for(let[,,n]of e.source.matchAll(Q))for(let[,e]of n.matchAll(Fe))t.includes(e)||t.push(e);return t}function Le(e){let t=[];for(let[,n,r]of e.source.matchAll(Q))n.length===2&&t.push(q(r));return t}function Re(e){return{destination:`~/.hub-william/${e.id}.md`,invocations:Ie(e),sections:Le(e)}}function ze(e){return`${z}/new/main/${L}/${e.contributor??R}/${me(e.section)}/${e.category}`}function $(e,t){return J.filter(n=>n.section===e&&n.contributor===t)}function Be(e=`library`,t=null){return $(e,t).length}function Ve(e=`library`,t=null){return new Set($(e,t).map(e=>e.group)).size}var He={contributors:Se,fileName:Oe,contributeUrl:ze,documentCount:Be,documentUrl:Me,findBySlug:Ce,findMarkdownReference:we,findCategory:Te,groupCount:Ve,groupsInCategory:Ee,listEntriesByCategory:Y,rootArchive:Pe,rootsInSection:X,matchesQuery:De,sourceUrl:ke,usage:Re};export{W as a,pe as i,He as n,U as r,z as t};