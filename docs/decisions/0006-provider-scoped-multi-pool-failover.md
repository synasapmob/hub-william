...
- Status: Accepted; upstream authentication failure handling superseded by ADR-0010, transient response handling superseded by ADR-0022, and per-pool member capacity superseded by ADR-0023
- Date: 2026-09-10
